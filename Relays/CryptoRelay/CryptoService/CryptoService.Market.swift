...
//    public func getMarketChart(matching ticker: String,
//                               from pastEpoch: String,
//                               to futureEpoch: String,
//                               interval: SecurityInterval) -> AnyPublisher<[StockServiceModels.Stock], URLError> {
//        guard
