...
public struct SearchComponent: GraniteComponent {
    ...
    @Environment(\.searchManager) var searchManager: SearchManager
        ...
        VStack {
            HStack {
                HStack {
                    ...
                    TextField("search markets", text: searchManager.$search.query)
                        .onChange(of: searchManager.search.query,
                                  perform: { q in
