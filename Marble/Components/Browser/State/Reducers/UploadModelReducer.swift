...
struct UploadMergedModelReducer: Reducer {
    typealias ReducerEvent = BrowserEvents.UploadMergedModel
    typealias ReducerState = BrowserState
    ...
    func reduce(
        ...
        guard let model = event.model?.asModel, let data = model.model?.archived else { return }
