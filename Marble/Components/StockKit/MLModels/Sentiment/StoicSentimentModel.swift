...
class StoicSentimentModel {
    ...
    func predict(_ utterance: String) -> VaderSentimentOutput? {
        ...
        return VaderSentimentOutput.init(pos: Double(averages[2]), neg: Double(averages[0]), neu: Double(averages[1]), compound: 0.0)
    }
