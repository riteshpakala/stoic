...
open class AssetsAlbumCell: UICollectionViewCell, AssetsAlbumCellProtocol {
    ...
    fileprivate let titleLabel: UILabel = {
        ...
        label.font = UIFont(name: LSConst.Fonts.PlayfairBold, size: 16) ?? UIFont.systemFont(forStyle: .subheadline)
        return label
    }()
    ...
    fileprivate let countLabel: UILabel = {
        ...
        label.font = UIFont(name: LSConst.Fonts.PlayfairRegular, size: 14) ?? UIFont.systemFont(forStyle: .subheadline)
        return label
    }()
