...
open class AssetsPickerConfig {
    ...
    public static var defaultCheckmarkColor: UIColor = .black// UIColor(red: 0.078, green: 0.435, blue: 0.875, alpha: 1)
    ...
    open var albumDefaultSpace: CGFloat = 12//20
    ...
    open var assetLandscapeColumnCount: Int = UI_USER_INTERFACE_IDIOM() == .pad ? 5 : 6
    open var assetLandscapeInteritemSpace: CGFloat = 1
    open var assetLandscapeLineSpace: CGFloat = 1
